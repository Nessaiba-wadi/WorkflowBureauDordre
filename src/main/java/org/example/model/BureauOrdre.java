...
public class BureauOrdre {
    ...
    public void setRaisonSocialeGBM(String raisonSocialeGBM) {
        this.raisonSocialeGBM = raisonSocialeGBM;
    }
    ...
    public void creerEntreeBureauOrdre() {
        System.out.println("Entrée bureau ordre créée.");
    }

    public void modifierEntreeBureauOrdre() {
        System.out.println("Entrée bureau ordre modifiée.");
    }

    public void supprimerEntreeBureauOrdre() {
        System.out.println("Entrée bureau ordre supprimée.");
    }
}